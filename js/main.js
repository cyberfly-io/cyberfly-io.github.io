...
$(function () {
  ...
  $(".menu-link").on("click", function() {
    // Check if the clicked menu item has the id "tokenomics"
    if (!$(this).is('[id="token-menu"]')) {
      // Your existing code to close the menu
      pageHeader.find(".menu-wrapper").removeClass("show");
      pageHeader.find(".show:not(.menu-wrapper)").toggleClass("show");
